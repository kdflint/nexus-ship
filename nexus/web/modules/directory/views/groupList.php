			 	...
			 	for (var i = 0; i < jsonObj.length; i++) { 
 					...
 					tr.setAttribute("id", "group-list-table-row-" + i);
 						...
 						var td2 = document.createElement("TD");
							...
							// NOTE: We are depending on this className 'fa' string literal in nexus.php approx. line 222
						...
						var td5 = document.createElement("TD");
							var dateContent = document.createTextNode(jsonObj[i].join_date);
							td5.appendChild(dateContent);
 						var td6 = document.createElement("TD");
							...
							anchorDelete.setAttribute("style", "float:right;");
 							anchorDelete.setAttribute("onclick", "return confirm(\"Please confirm this delete of " + jsonObj[i].fname + " " + jsonObj[i].lname + ".\");");
 							var spanDelete = document.createElement("SPAN");
							// NOTE: We are depending on these className 'fa' string literals in nexus.php approx. line 222
 							...
 							anchorEdit.setAttribute("style", "padding-right:20px;float:right;");
							...
							if (IS_ADMIN && (jsonObj[i].sessionUser != jsonObj[i].uidpk)) {
 								td6.appendChild(anchorDelete);
 								td6.appendChild(anchorEdit);
 							}
 					tr.appendChild(td1);	
    				tr.appendChild(td2);
 					tr.appendChild(td3);	
...
<form id="member-directory-form" action="#" method="post">
	...
	<table id="member-directory" class="display" width="100%" cellspacing="0">	
		<thead>
			<tr><th>Mark</th><th>Details</th><th>First</th><th>Last</th><th>Joined</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th></tr>
		</thead>
