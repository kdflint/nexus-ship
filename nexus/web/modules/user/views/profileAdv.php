...
<div class="leftColumn">
	<p><b>You</b><span style="color:#bf6030;margin-left:50px;"><?php echo $error; ?></span><p>
	<div style="margin-left:20px;margin-top:5px;">
			<table cellpadding="2" width="100%">
 			...
 			<tr><td><a href="#" class="tooltip" title="1-25 characters. May contain letters, numbers, accents, &apos; or _">First</a></td><td>
	 			<input type="text" size="22" name="fname" value="<?php echo($_SESSION['fname']);?>" />
	 		</td></tr>
 			...
 			<tr><td valign="top"><a href="#" class="tooltip" title="Optional, 1-250 characters. May contain accents and sentence punctuation.">A few words about you:</a></td><td valign="top"><textarea maxlength="250" rows="4" cols="30" name="about" ><?php echo $descr; ?></textarea></td></tr>
		</table>
	</div>
	...
	<div style="margin-left:20px;">
		<table cellpadding="2">
			<tr>
				<td colspan="2">	
					<a id="testMessageLink" href="javascript:post('../control/messageProcessor.php',{testMessage:'true',phone:'<?php echo($testSms); ?>',email:'<?php echo($testEmail); ?>'})">
