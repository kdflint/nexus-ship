...
$creationParams = array(
	'meetingId' => $meetingId,
	'meetingName' => array_values($_SESSION['groups'])[0] . " Conference Room",
	'attendeePw' => 'ap',
	'moderatorPw' => 'mp',
	...
	'voiceBridge' => '',
	'webVoice' => '',
	'logoutUrl' => Util::getHttpPath() . '/roomLogout.html',
	'maxParticipants' => '',
	'record' => '',
	'duration' => '0'
);
...
if ($itsAllGood) {
	if ($clean['mtype'] == 'video chat') {
		try {
			$response = $bbb->setMeetingConfig(getVCConfigXml(), $meetingId);
		...
		try {
			$response = $bbb->setMeetingConfig(getCollabConfigXml(), $meetingId);
			if (strcasecmp($response['returncode'], 'SUCCESS') != 0 || !isset($response['token']) || strlen($response['token']) < 1) {
				$itsAllGood = FALSE;
			} else {
				$configToken = (string)$response['token'];
...
<config>
    ...
    <bwMon server="ec2-50-19-215-104.compute-1.amazonaws.com" application="video/bwTest"/>
    ...
    <lock disableCamForLockedUsers="false" disableMicForLockedUsers="false" disablePrivateChatForLockedUsers="false" 
		...
		<module name="ChatModule" url="http://ec2-50-19-215-104.compute-1.amazonaws.com/client/ChatModule.swf?v=264" 
		...
		<module name="UsersModule" url="http://ec2-50-19-215-104.compute-1.amazonaws.com/client/UsersModule.swf?v=264" 
			uri="rtmp://ec2-50-19-215-104.compute-1.amazonaws.com/bigbluebutton" 
			allowKickUser="true"
		...
		<module name="DeskShareModule" 
			url="http://ec2-50-19-215-104.compute-1.amazonaws.com/client/DeskShareModule.swf?v=264" 
		...
		<module name="PhoneModule" url="http://ec2-50-19-215-104.compute-1.amazonaws.com/client/PhoneModule.swf?v=264" 
		...
		<module name="VideoconfModule" url="http://ec2-50-19-215-104.compute-1.amazonaws.com/client/VideoconfModule.swf?v=264" 
		...
		<module name="WhiteboardModule" url="http://ec2-50-19-215-104.compute-1.amazonaws.com/client/WhiteboardModule.swf?v=264" 
			uri="rtmp://ec2-50-19-215-104.compute-1.amazonaws.com/bigbluebutton" 
		...
		<module name="PresentModule" url="http://ec2-50-19-215-104.compute-1.amazonaws.com/client/PresentModule.swf?v=264" 
			uri="rtmp://ec2-50-19-215-104.compute-1.amazonaws.com/bigbluebutton" 
		...
		<module name="VideodockModule" url="http://ec2-50-19-215-104.compute-1.amazonaws.com/client/VideodockModule.swf?v=264"
			uri="rtmp://ec2-50-19-215-104.compute-1.amazonaws.com/bigbluebutton" 
		...
		<module name="LayoutModule" url="http://ec2-50-19-215-104.compute-1.amazonaws.com/client/LayoutModule.swf?v=264"
			uri="rtmp://ec2-50-19-215-104.compute-1.amazonaws.com/bigbluebutton"
