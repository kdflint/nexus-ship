       	...
       	<span class="banner">
					...
					<a id="menu-recordList" class="pure-button button-menu-adv" href="javascript:void(0)" onclick="toggleFrameDisplay('recordList')" style="float:right;background-color:#dae0bc;">ARCHIVE</a> 			
					<a id="menu-userList" class="pure-button button-menu-adv" href="javascript:void(0)" onclick="toggleFrameDisplay('userList')" style="float:right;background-color:#dae0bc;margin-right:-7px;" >TEAM</a>
					<a id="menu-reserveList" class="pure-button button-menu-adv active" href="javascript:void(0)" onclick="toggleFrameDisplay('reserveList')" style="float:right;background-color:rgba(137, 157, 112, 1);margin-right:-7px;">ROOM</a> 
					<!--
      	...
      	<a id="profile_control" href="javascript:void(0);"><span id="profile_control_icon" style="clear:right;float:right;padding-top:10px;margin:0px;color:#d27b4b;" class="fa fa-lg fa-plus-square" ></span></a>
				...
				<div id="openTrainModal" class="modalDialog">
					<div>
						...
						<p>Please log in to the <a href="<?php echo Utilities::getMemberUrl(); ?>" target="_blank">Northbridge Member Portal</a> to register for Nexus Web Meet training.</p>
						<!--
