...
SELECT pg_catalog.setval('forum_user_id_seq', 128, true);
...
SELECT pg_catalog.setval('invitation_id_seq', 41, true);
...
SELECT pg_catalog.setval('organization_id_seq', 326, true);
...
SELECT pg_catalog.setval('organization_organization_id_seq', 313, true);
...
SELECT pg_catalog.setval('user_group_id_seq', 106, true);
...
SELECT pg_catalog.setval('user_id_seq', 233, true);
...
SELECT pg_catalog.setval('user_organization_id_seq', 211, true);
...
SELECT pg_catalog.setval('user_password_id_seq', 35, true);
...
SELECT pg_catalog.setval('user_session_id_seq', 314, true);
...
INSERT INTO "user" VALUES (176, '174eaaa7-d501-7c2b-5a11-63709d403b0b', 'lou1', '[[ENC]]b10904f29f1bf1059097d5541878c1eba3b578d2e0445225fcc924db8dee14eb', 'lou', '', 'lou', '2014-09-21 20:11:57.916885-06', NULL, '2014-09-21 20:11:57.916885-06', NULL, 1, '', 'coach.lou@northbridgetech.org', '', true, false, NULL, 'ImplA', 'NtFwdEPxqcdE)f1e6KWsfOgNhFX9AO9d', '2014-10-21 20:31:40.62091-06', '/openmeetings/swf?invitationHash=83f41a436e497c1e84bf010a9a2137ec');
...
INSERT INTO "user" VALUES (88, 'e8db0a62-67dd-3d0c-13fd-d2372f4b5d0c', 'admin', 'admin', 'Kathy', '', 'Flint', '2014-08-01 15:09:53.514038-06', NULL, '2014-08-01 15:09:53.514038-06', NULL, 1, '', 'contact@northbridgetech.org', '', true, false, NULL, 'none', NULL, NULL, '');
...
INSERT INTO user_password VALUES (33, 190, 'RESET', '2014-10-29 20:05:23.527165-06', '2014-10-29 20:05:49.820168-06', '72e819c5-41c7-65c3-4c62-acafe788fbe5');
