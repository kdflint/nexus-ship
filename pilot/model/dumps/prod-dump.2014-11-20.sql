...
SELECT pg_catalog.setval('forum_user_id_seq', 56, true);
...
SELECT pg_catalog.setval('organization_id_seq', 289, true);
...
SELECT pg_catalog.setval('organization_organization_id_seq', 285, true);
...
SELECT pg_catalog.setval('user_id_seq', 137, true);
...
SELECT pg_catalog.setval('user_organization_id_seq', 136, true);
...
SELECT pg_catalog.setval('user_session_id_seq', 228, true);
