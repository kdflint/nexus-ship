...
SELECT pg_catalog.setval('forum_user_id_seq', 36, true);
...
SELECT pg_catalog.setval('user_group_id_seq', 17, true);
...
SELECT pg_catalog.setval('user_id_seq', 117, true);
...
SELECT pg_catalog.setval('user_organization_id_seq', 116, true);
...
SELECT pg_catalog.setval('user_session_id_seq', 100, true);
