<?php
	...
	// To solve chat asking to log in, put the path to this file under the "Login Page" setting in the forum
	// But then that breaks the forum topic digest link - argh.

	// LEFT OFF - Add some styling to match regular site
