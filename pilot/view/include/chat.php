...
<div class="topLeftQuad">
 	...
 	<!--
 	<table>
 		<tr><td>Telephone Line:</td><td><?php echo $wc_phone[$_SESSION['networkId']]; ?></td></tr>
 		<tr><td>Meeting ID:</td><td><?php echo $wc_code[$_SESSION['networkId']]; ?>#</td></tr>
 		<tr><td>Host PIN:</td><td><?php echo $wc_pin; ?>#</td></tr>
	</table>
	...
	<!-- TODO - something comparable with new system -->
		<?php if (isset($roomLink) && strlen($roomLink) > 1) {
		...
		?>
		<p>
		<!--<a class="bigbutton" href="<?php echo $formattedLink; ?>" target="_blank" >-->
...
<p style="margin-left:20px;"><?php echo $_SESSION['networkName']; ?> users are eligible for free, personalized, no-obligation training on how to use Nexus web conferencing. This will help your group take full advantage of the benefits of web conferencing.</p>
...
<div class="rightColumnPlain" style="left:360px;width:450px;">	
	 ...
	 <iframe src="http://northbridgetech.org/<?php echo $env_appRoot; ?>/nexus/view/include/conferenceTechCheck.html" width="100%" height="75%" frameborder="0" scrolling="no"></iframe> 
</div>
