  ...
  <head> 
	...
	<body>
 			...
 			<table style="font-size:12px;width:350px;" cellpadding="5">
 				...
 				<tr><td bgcolor="#eeeeee" valign="top" style="text-align: left;">Download&nbsp;Speed</td valign="top" style="text-align: left "><td valign="top" style="text-align: left;"><img id="download_speed" src="http://northbridgetech.org/dev/nexus/view/image/light_white.png" /></td><td valign="top" style="text-align: left "><p id="progress"><? echo $speed; ?></p></td></tr>
 				<tr><td bgcolor="#eeeeee" valign="top" style="text-align: left;">Upload&nbsp;Speed</td valign="top" style="text-align: left "><td valign="top" style="text-align: left;"><img id="download_speed" src="http://northbridgetech.org/dev/nexus/view/image/light_white.png" /></td><td valign="top" style="text-align: left ">TODO</p></td></tr>
 				<tr>
