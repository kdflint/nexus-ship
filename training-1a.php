				...
				xmlhttp.onreadystatechange=function() {
  				if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {					 					
    				if (xmlhttp.responseText.indexOf('open') > -1) {
    					...
    					//alert("The training session on Wednesday, August 26 at 1:00 pm CT has been CANCELLED. We are sorry for the inconvenience! Please check for an email from Eventbrite for further details.");
